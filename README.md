...
also pins
`AstroVela/vane@b96fe5e26158646711509b1db3874e476f911684`
(`vane-ai==0.2.0.dev658`). CMake explicitly
...
`vane-extension-vortex` wheel, with exact `vane-ai==0.2.0.dev658` dependencies
...
the dev658 contract stays unchanged. Adding the workflow does not itself publish
